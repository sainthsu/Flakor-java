 ...
 * @see <a href="http://code.google.com/p/android/issues/detail?id=11078">http://code.google.com/p/android/issues/detail?id=11078</a>
 * <a href="http://code.google.com/p/android/issues/detail?id=16941">http://code.google.com/p/android/issues/detail?id=16941</a>
 */
public class BufferUtils
{
    ...
    static {
        ...
        else 
        {
            WORKAROUND_BYTEBUFFER_ALLOCATE_DIRECT = false;
            if(SystemUtils.isAndroidVersion(Build.VERSION_CODES.HONEYCOMB, Build.VERSION_CODES.HONEYCOMB_MR2)) {
                Debug.e("Creating a " + ByteBuffer.class.getSimpleName() + " will actually allocate 4x the memory than requested!");
            }
    ...
    public static void put(final ByteBuffer pByteBuffer, final float[] pSource, final int pLength, final int pOffset)
    {
        ...
        else
        {
            ...
            Debug.e("WORKAROUND_BYTEBUFFER_PUT_FLOATARRAY");
        }
